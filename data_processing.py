...
parser.add_argument("--data2",default="./data/本年度每日尖峰備轉容量率.csv",help="Input your power data.")
parser.add_argument("--data3",default="./data/Weather/",help="Input your weather data.")
parser.add_argument("--data4",default="./data/Holiday/",help="Input your holiday data.")
